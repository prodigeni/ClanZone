...
/* do not edit above this line */
	...
	'clanwar_message'=>'new upcoming clanwar on %date%:[br][br]Team 1: [url=%team1_hp%]%team1%[/url][br]Team 2: [url=%team2_hp%]%team2%[/url][br]League: [url=%league_hp%]%league%[/url] [br]Info: %warinfo%[br][br][url=index.php?site=calendar]link to calendar[/url]',
